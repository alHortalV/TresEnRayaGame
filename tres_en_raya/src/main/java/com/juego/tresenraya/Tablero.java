...
public class Tablero {
    ...
    private static int victoriasJugador1 = 0;
        ...
        public static void escribirVictoriaDocumentoTexto(int jugador){
            try{
                ...
                escribir.write("VictoriasJugador1: " + victoriasJugador1 + "\n");
                escribir.write("VictoriasJugador2: " + victoriasJugador2 + "\n");
                escribir.write("------------------------\n");
                escribir.close();
            }catch (IOException e) {
        }
